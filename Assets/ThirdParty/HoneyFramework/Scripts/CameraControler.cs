...
namespace HoneyFramework
{
    ...
    public class CameraControler : MonoBehaviour
    {
        ...
        private bool WorldLoadStarted = false;
        ...
        void Update()
        {
            ...
            if (World.GetInstance() != null && Input.GetMouseButtonDown(0) && World.GetInstance().status == World.Status.Ready)
            {
                ...
                if (Plane.Raycast(ray, out ent))
                {
                    ...
                    if (HoneyFrameworkGameManager.instance.formations.Count > 0)
                    {
                        HoneyFrameworkGameManager.instance.formations[HoneyFrameworkGameManager.instance.formations.Count - 1].GoTo(hexPos);
                    }
...
//                     }
            ...
            if (!WorldLoadStarted)
            {
                ...
                AstarPath.RegisterSafeUpdate(HoneyFrameworkGameManager.instance.ActivatePathfinder);
...
//                    }
//                    HoneyFrameworkGameManager.instance.formations.Add(f);
//                }
//
