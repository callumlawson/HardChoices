...
#region Styles
	...
	UndoPropertyModification[] OnPostProcessModifications (UndoPropertyModification[] mods) {
		...
		for (int i = 0; i < mods.Length; i++) {
            s += mods[i].currentValue.propertyPath + "\n";
		}
		Debug.Log ("Saved:\n"+s);
		return mods;
	}
